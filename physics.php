        ...
        <div class="carousel-inner" role="listbox">
         ...
         <div class="item active">
            ...
            <div class="carousel-container">
              ...
              <form action="logout.php" method="post"> <button style="margin-top:-500px;margin-left:1350px; color:white; background-color:rgb(1,193,193); height:50px; width:90px;" name="sub" >Sign Out</button></form>
