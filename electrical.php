                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-7 col-sm-12 wow fadeInLeft">
                            <div class="content">
                            <form action="logout.php" method="post"> <button style="margin-top:-1540px;margin-left:1210px; color:white; background-color:rgb(1,193,193); height:50px; width:90px;"  name="sub">Sign Out</button></form>
